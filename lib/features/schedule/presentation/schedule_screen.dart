...
class ScheduleScreen extends ConsumerWidget {
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  IconButton(
                    onPressed: () => ref.read(selectedScheduleDateProvider.notifier).state =
                    ...
                    child: Row(
                      ...
                      children: weekDates.map((date) {
                        ...
                        return GestureDetector(
                          onTap: () => ref.read(selectedScheduleDateProvider.notifier).state = date,
                          child: Container(
                            padding: const EdgeInsets.symmetric(vertical: 8, horizontal: 8),
                            decoration: BoxDecoration(
                              color: isSelected ? AppColors.pine : Colors.transparent,
                              ...
                              children: [
                                Text(
                                  ...
                                  style: AppTypography.eyebrow(
                                    color: isSelected ? AppColors.white : AppColors.inkMute,
                                  ),
                                ),
                                const SizedBox(height: 4),
                                Text(
              ...
              child: daySlots.isEmpty
                  ? Center(
                      child: Column(
                        ...
                        children: [
                          Icon(Icons.event_busy_outlined, size: 48, color: AppColors.inkMute),
                          const SizedBox(height: 12),
                          Text('No slots for this day', style: AppTypography.bodyMedium()),
                          const SizedBox(height: 8),
                          TextButton.icon(
                  ...
                  : ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return _SlotCard(
                          slot: slot,
                          lang: lang,
                          onTap: () => _showSlotActions(context, ref, slot, lang),
                        );
                      },
                    ),
            ),
  ...
  void _showAddSlotSheet(BuildContext context, WidgetRef ref, DateTime date) {
    final times = ['08:00 AM', '09:00 AM', '10:00 AM', '11:00 AM', '12:00 PM',
      ...
      builder: (ctx) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(DateFormatter.formatFullDate(date), style: AppTypography.bodySmall()),
            const SizedBox(height: 16),
            Wrap(
              spacing: 8,
              runSpacing: 8,
              children: times.map((time) => ActionChip(
  ...
  void _showSlotActions(BuildContext context, WidgetRef ref, AvailabilitySlot slot, AppLanguage lang) {
      ...
      builder: (ctx) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('${slot.time} · ${DateFormatter.formatShortDate(slot.date)}', style: AppTypography.bodySmall()),
            const SizedBox(height: 20),
            if (slot.status == SlotStatus.open)
              ListTile(
                leading: const Icon(Icons.block, color: AppColors.danger),
                title: Text(AppStrings.get('blocked', lang), style: AppTypography.bodyLarge()),
                subtitle: Text('Block this time slot', style: AppTypography.bodySmall()),
                onTap: () {
              ...
              ListTile(
                leading: const Icon(Icons.check_circle_outline, color: AppColors.pine),
                title: Text('Open Slot', style: AppTypography.bodyLarge()),
                subtitle: Text('Make available for bookings', style: AppTypography.bodySmall()),
                onTap: () {
    ...
    return AppCard(
      ...
      child: Row(
        children: [
          ...
          Text(slot.time, style: AppTypography.bodyLarge(fontWeight: FontWeight.w600)),
          const Spacer(),
          if (slot.status == SlotStatus.booked && slot.patientName != null) ...[
            Column(
              crossAxisAlignment: CrossAxisAlignment.end,
              children: [
                Text(slot.patientName!, style: AppTypography.bodyMedium(fontWeight: FontWeight.w500)),
